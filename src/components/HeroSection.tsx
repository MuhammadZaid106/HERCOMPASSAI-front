...
export default function HeroSection() {
  ...
  return (
    <section className="relative overflow-hidden pt-6 pb-14 sm:pt-10 sm:pb-20 lg:pt-16 lg:pb-28">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-start text-left">
            ...
            {/* Dual CTAs */}
            <div className="mt-6 sm:mt-8 flex flex-col items-stretch gap-3 w-full max-w-xs sm:flex-row sm:items-center sm:max-w-none sm:w-auto">
              <Link
                href="/onboarding"
                className="inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-violet-600 to-indigo-600 px-5 py-3 text-sm font-semibold text-white shadow-lg shadow-violet-500/25 transition-all hover:shadow-xl hover:shadow-violet-500/35 hover:-translate-y-0.5 active:translate-y-0"
              >
            ...
            {/* Trust Badges */}
            <div className="mt-8 grid grid-cols-1 gap-3 pt-6 border-t border-slate-200/70 w-full sm:grid-cols-3 sm:gap-4 sm:mt-10 sm:pt-8">
          ...
          <div className="lg:col-span-5 relative">
            ...
            <div className="relative rounded-3xl border border-slate-200/90 bg-white/95 p-4 sm:p-6 shadow-2xl shadow-slate-200/60 backdrop-blur-sm">
              {/* Card Header & View Switcher — stacks on mobile */}
              <div className="flex flex-col gap-2.5 pb-4 border-b border-slate-100 sm:flex-row sm:items-center sm:justify-between sm:pb-5">
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-0.5">
                    Maria, 47 • Perimenopause • Week 4
                  </p>
                </div>

                {/* Perspective Toggle */}
                <div className="flex self-start rounded-xl bg-slate-100 p-1 border border-slate-200/60">
                  <button
                    type="button"
              ...
              {activeTab === "member" ? (
                <>
                  ...
                  <div className="mt-4 sm:mt-5 grid grid-cols-2 gap-2.5 sm:gap-3.5">
                    {/* Mood Trend */}
                    <button
                      type="button"
                      onClick={() => setActiveMetric("mood")}
                      className={`text-left rounded-2xl p-3 sm:p-4 transition-all duration-200 border ${
                        activeMetric === "mood"
                    ...
                    >
                      ...
                      <div className="mt-2 flex items-baseline gap-1">
                        <span className="text-xl font-bold text-slate-900 sm:text-2xl">6%</span>
                    ...
                    >
                      ...
                      <div className="mt-2 flex items-baseline gap-1">
                        <span className="text-xl font-bold text-slate-900 sm:text-2xl">90%</span>
                        <span className="text-[10px] font-semibold text-emerald-600">7.6 hrs</span>
                      </div>
                    ...
                    >
                      ...
                      <div className="mt-2 flex items-baseline gap-1">
                        <span className="text-xl font-bold text-slate-900 sm:text-2xl">Yes</span>
                        <span className="text-[10px] font-medium text-amber-700">Mon 8:15</span>
                      </div>
                  ...
                  <div className="mt-3 rounded-2xl bg-slate-50 border border-slate-200/80 p-3 transition-all animate-in fade-in-50 duration-300">
                    <div className="flex items-start justify-between gap-2 mb-2">
                      ...
                      <span className="rounded-md bg-white px-1.5 py-0.5 text-[10px] font-medium text-slate-600 border border-slate-200 whitespace-nowrap flex-shrink-0">
              ...
              <div className="mt-4 flex flex-wrap items-center justify-between gap-2 pt-3 border-t border-slate-100 text-xs text-slate-500">
                <div className="flex items-center gap-1.5">
