...
import { ArrowRight, HeartHandshake, ShieldCheck, CheckCircle2, Sparkles } from "lucide-react";
  ...
  return (
    <section className="py-12 sm:py-16 lg:py-24 bg-gradient-to-b from-[#FAF9F6] to-white relative overflow-hidden">
      <div className="mx-auto max-w-7xl px-3 sm:px-6 lg:px-8">
        ...
        <div className="relative rounded-3xl bg-gradient-to-br from-slate-900 via-slate-800 to-indigo-950 p-5 sm:p-10 lg:p-16 text-white shadow-2xl overflow-hidden">
          
          {/* Ambient Background Glows */}
          <div className="absolute top-0 right-0 -mt-16 -mr-16 h-80 w-80 rounded-full bg-indigo-600/20 blur-3xl pointer-events-none" />
          ...
          <div className="relative z-10 max-w-3xl mx-auto text-center">
            ...
            {/* Pill Tag */}
            <div className="inline-flex items-center gap-2 rounded-full border border-indigo-400/30 bg-indigo-500/15 px-3.5 py-1 text-xs font-semibold text-indigo-200 mb-4 sm:mb-6 backdrop-blur-xs">
              <Sparkles className="h-3.5 w-3.5 text-indigo-300" />
              <span>Ready to Begin Your Personal Compass?</span>
            </div>

            <h2 className="text-xl sm:text-3xl lg:text-5xl font-extrabold tracking-tight text-white leading-tight">
              Start with 5 Minutes Today. Experience Clarity This Week.
            </h2>

            <p className="mt-3.5 sm:mt-5 text-xs sm:text-base lg:text-lg text-slate-300 leading-relaxed max-w-2xl mx-auto">
              Join thousands of women and their partners navigating midlife transitions with evidence-backed predictability,
              compassionate AI interpretations, and zero guesswork.
            </p>

            {/* CTAs — side-by-side, compact padding, shrink-safe */}
